...
import Wirelessdata from "../db/Wirelessdata";
import { PortablespeakerPriceFilter} from "../Components/PriceFilter";
import { EarbudsBrandFilter} from "../Components/Brandfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <PortablespeakerPriceFilter handlePriceChange={handlePriceChange} />
          < EarbudsBrandFilter handleFilterChange={handleBrandChange} />
