...
import Macbookprodata from "../db/Macbookprodata";
import { MacbookPriceFilter} from "../Components/PriceFilter";
// import { StrapsBrandFilter} from "../Components/Brandfilter";
import { MacbookColorFilter} from "../Components/Colorsfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <MacbookPriceFilter handlePriceChange={handlePriceChange} />
          {/* < StrapsBrandFilter handleFilterChange={handleBrandChange} /> */}
          <MacbookColorFilter handleFilterChange={handleColorChange} />
        </Col>
        <Col xs={12} md={9} lg={9}>
