...
import FullHdtvdata from "../db/FullHdtvdata";
import {HdtvPriceFilter} from "../Components/PriceFilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <HdtvPriceFilter handlePriceChange={handlePriceChange} />
