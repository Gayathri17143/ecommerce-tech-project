    ...
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          ...
          <BasicphonesColorFilter handleFilterChange={handleColorChange} />
        </Col>
        <Col xs={12} md={9} lg={9}>
