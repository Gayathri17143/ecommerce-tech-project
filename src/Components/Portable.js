...
import Portabledata from "../db/Portabledata";
import { PortablespeakerPriceFilter} from "../Components/PriceFilter";
import { PortablespeakerBrandFilter} from "../Components/Brandfilter";
    ...
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          ...
          < PortablespeakerBrandFilter handleFilterChange={handleBrandChange} />
