...
import Iphonesdata  from "../db/Iphonesdata";
import {IphonesPriceFilter} from "../Components/PriceFilter";
// import BasicphonesBrandFilter from "../Components/Brandfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <IphonesPriceFilter handlePriceChange={handlePriceChange} />
          {/* <BasicphonesBrandFilter handleFilterChange={handleBrandChange} /> */}
