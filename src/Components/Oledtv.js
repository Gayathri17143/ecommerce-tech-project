...
import Oledtvdata from "../db/Oledtvdata";
import { QLEDtvPriceFilter} from "../Components/PriceFilter";
import { HdtvBrandFilter} from "../Components/Brandfilter";
    ...
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          ...
          < HdtvBrandFilter handleFilterChange={handleBrandChange} />
