...
import Wireddata from "../db/Wireddata";
import { WiredPriceFilter} from "../Components/PriceFilter";
import { WiredBrandFilter} from "../Components/Brandfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          < WiredPriceFilter handlePriceChange={handlePriceChange} />
          < WiredBrandFilter handleFilterChange={handleBrandChange} />
