...
import Bluetoothspeakerdata from "../db/Bluetoothspeakerdata";
import { SoundbarPriceFilter} from "../Components/PriceFilter";
import { BluetoothBrandFilter} from "../Components/Brandfilter";
...
const ProductList = () => {
  ...
  useEffect(() => {
    ...
    if (storedProducts) {
      ...
      setProducts(Bluetoothspeakerdata);
    }
  }, []);
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          < SoundbarPriceFilter handlePriceChange={handlePriceChange} />
          < BluetoothBrandFilter handleFilterChange={handleBrandChange} />
