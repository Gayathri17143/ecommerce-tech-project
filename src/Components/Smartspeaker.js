...
import Smartspeakerdata from "../db/Smartspeakerdata";
import { SmartspeakerPriceFilter} from "../Components/PriceFilter";
import { SmartspeakerBrandFilter} from "../Components/Brandfilter";
import {SmartspeakerColorFilter} from "../Components/Colorsfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          < SmartspeakerPriceFilter handlePriceChange={handlePriceChange} />
          < SmartspeakerBrandFilter handleFilterChange={handleBrandChange} />
          <SmartspeakerColorFilter handleFilterChange={handleColorChange} />
        </Col>
        <Col xs={12} md={9} lg={9}>
