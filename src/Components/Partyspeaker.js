...
import Partyspeakerdata from "../db/Partyspeakerdata";
import { FitnesswatchPriceFilter} from "../Components/PriceFilter";
import {  SoundbarBrandFilter} from "../Components/Brandfilter";
    ...
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          ...
          < SoundbarBrandFilter handleFilterChange={handleBrandChange} />
