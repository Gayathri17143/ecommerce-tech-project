...
import Earbudsdata from "../db/Earbudsdata";
import { EarphonesPriceFilter} from "../Components/PriceFilter";
import { EarbudsBrandFilter} from "../Components/Brandfilter";
import {IphonesColorFilter} from "../Components/Colorsfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <EarphonesPriceFilter handlePriceChange={handlePriceChange} />
          < EarbudsBrandFilter handleFilterChange={handleBrandChange} />
          <IphonesColorFilter handleFilterChange={handleColorChange} />
        </Col>
        <Col xs={12} md={9} lg={9}>
