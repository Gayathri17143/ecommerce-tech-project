...
import Androidtvdata from "../db/Androidtvdata";
import {AndroidtvPriceFilter} from "../Components/PriceFilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <AndroidtvPriceFilter handlePriceChange={handlePriceChange} />
