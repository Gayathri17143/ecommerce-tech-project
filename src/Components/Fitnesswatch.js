...
import Fitnesswatchdata from "../db/Fitnesswatchdata";
import {FitnesswatchPriceFilter} from "../Components/PriceFilter";
import {FitnesswatchBrandFilter} from "../Components/Brandfilter";
import {FitnesswatchColorFilter} from "../Components/Colorsfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          <FitnesswatchPriceFilter handlePriceChange={handlePriceChange} />
          <FitnesswatchBrandFilter handleFilterChange={handleBrandChange} />
          <FitnesswatchColorFilter handleFilterChange={handleColorChange} />
        </Col>
        <Col xs={12} md={9} lg={9}>
