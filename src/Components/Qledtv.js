...
import Qledtvdata from "../db/Qledtvdata";
import { QLEDtvPriceFilter} from "../Components/PriceFilter";
import { AndroidtvBrandFilter} from "../Components/Brandfilter";
  ...
  return (
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          < QLEDtvPriceFilter handlePriceChange={handlePriceChange} />
          < AndroidtvBrandFilter handleFilterChange={handleBrandChange} />
