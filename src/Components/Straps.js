...
import Strapsdata from "../db/Strapsdata";
import { SmartspeakerPriceFilter} from "../Components/PriceFilter";
import { StrapsBrandFilter} from "../Components/Brandfilter";
    ...
    <Container>
      <Row style={{ padding: "30px" }}>
        ...
        <Col xs={12} md={3} lg={3}>
          ...
          < StrapsBrandFilter handleFilterChange={handleBrandChange} />
